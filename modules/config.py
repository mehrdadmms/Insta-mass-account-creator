...
Config = {
    ...
    "chromedriver_path": r"F:\projects\neolyze_current\chromedriver_win32\chromedriver.exe",  # if windows 'chromedriver.exe'
    "use_custom_proxy": False,  # default is False change to True to use a file containing multiple proxies of yours.
    "use_local_ip_address": True,   # default is False change to True to user your computers ip directly.
